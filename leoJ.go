...
func main() {
	...
	for _, p := range productos {
		...
		pdf.CellFormat(40, 10, fmt.Sprintf("COP %.2f", p.Precio), "1", 0, "C", false, 0, "")
		pdf.CellFormat(40, 10, fmt.Sprintf("COP %.2f", totalProducto), "1", 0, "C", false, 0, "")
		pdf.Ln(10)
	}
	...
	pdf.CellFormat(40, 10, fmt.Sprintf("COP %.2f", totalGeneral), "1", 0, "C", false, 0, "")
